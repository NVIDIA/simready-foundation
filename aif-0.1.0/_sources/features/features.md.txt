...
| [AIF Core Metadata](FET_200-aif_metadata.md) *(capability)* | {bdg-info}`Capability` | <details><summary>1</summary>[AIF-Entity](../profiles/aif-entity.md)</details> | AIF | 0.1.0 | - | ✓ | - | FET200_AIF_NEUTRAL |
| [Connection Points](FET_201-connection_points.md) *(capability)* | {bdg-info}`Capability` | <details><summary>1</summary>[AIF-Entity](../profiles/aif-entity.md)</details> | AIF | 0.1.0 | - | ✓ | - | FET201_AIF_NEUTRAL |
| [AIF Thermal Cooling](FET_202-thermal_cooling.md) | {bdg-success}`Done` | <details><summary>1</summary>[AIF-Entity](../profiles/aif-entity.md)</details> | AIF | 0.1.0 | - | ✓ | - | FET202_AIF_NEUTRAL |
| [AIF Electrical](FET_203-electrical.md) | {bdg-success}`Done` | <details><summary>1</summary>[AIF-Entity](../profiles/aif-entity.md)</details> | AIF | 0.1.0 | - | ✓ | - | FET203_AIF_NEUTRAL |
...
> **AIF taxonomy note:** Under the AIF reorganization, AIF Core Metadata (`FET200`) and Connection Points (`FET201`) are **Capabilities**, not Features (their rules validate but do not change simulation output). They are documented under [Capabilities](../capabilities/capabilities) and remain listed here only as interim feature carriers: their rules stay in the feature JSON until SRF supports Profile-to-Capability referencing. Thermal Cooling (`FET202`) and Electrical (`FET203`) remain Features. All AIF assets validate against the single [`AIF-Entity`](../profiles/aif-entity.md) profile.
...
ID:200 - AIF Core Metadata <FET_200-aif_metadata>
ID:201 - Connection Points <FET_201-connection_points>
ID:202 - AIF Thermal Cooling <FET_202-thermal_cooling>
ID:203 - AIF Electrical <FET_203-electrical>
```
